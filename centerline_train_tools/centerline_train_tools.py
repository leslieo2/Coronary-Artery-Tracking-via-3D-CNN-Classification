...
def get_dataset(save_num=0):
    ...
    '''
    train_data_info_path = "../data_process_tools/patch_data/centerline_patch/train_save_d" + \
    ...
    val_data_info_path = "../data_process_tools/patch_data/centerline_patch/train_save_d" + \
        str(save_num)+"_val.csv"
    val_pre_fix_path = "../data_process_tools/patch_data/"
    val_flag = 'val'
    test_valid_transforms = None
    target_transform = None
    val_dataset = DataGenerater(val_data_info_path, val_pre_fix_path,
                                500, test_valid_transforms, val_flag, target_transform)
