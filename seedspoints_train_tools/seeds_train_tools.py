...
def get_dataset(save_num = 0):
    ...
    train_data_info_path = "../data_process_tools/patch_data/seeds_patch/train_save_d"+str(save_num)+"_train.csv"
    ...
    val_data_info_path = "../data_process_tools/patch_data/seeds_patch/train_save_d"+str(save_num)+"_val.csv"
